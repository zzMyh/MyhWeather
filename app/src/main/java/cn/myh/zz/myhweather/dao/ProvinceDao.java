...
public class ProvinceDao extends AbstractDao<Province, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ProvinceCode = new Property(2, String.class, "ProvinceCode", false, "PROVINCE_CODE");
    };
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PROVINCE\" (" + //
                ...
                "\"PROVINCE_CODE\" TEXT);"); // 2: ProvinceCode
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Province entity) {
        ...
        if (ProvinceCode != null) {
            stmt.bindString(3, ProvinceCode);
        }
    }
    ...
    public Province readEntity(Cursor cursor, int offset) {
        Province entity = new Province( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // ProvinceCode
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Province entity, int offset) {
        ...
        entity.setProvinceCode(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
