...
public class CityDao extends AbstractDao<City, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ProvinceId = new Property(3, String.class, "provinceId", false, "PROVINCE_ID");
    };
    ...
    public City readEntity(Cursor cursor, int offset) {
        City entity = new City( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // provinceId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, City entity, int offset) {
        ...
        entity.setProvinceId(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
